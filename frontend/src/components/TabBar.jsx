...
// Alerts now live in the Home header bell — the tab bar no longer shows badges.
export default function TabBar({ activeTab, onTabChange, showFAB, onDiagnosePress }) {
  return (
    <>
      {showFAB && (
